...
void CImageToolView::OnUpdateViewZoom1(CCmdUI* pCmdUI)
{
	...
	pCmdUI->SetCheck(m_nZoom == 1); // 현재 확대 비율이 1이면 체크 표시
}
...
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	pCmdUI->SetCheck(m_nZoom == 2); // 현재 확대 비율이 2이면 체크 표시
}
...
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	pCmdUI->SetCheck(m_nZoom == 3); // 현재 확대 비율이 3이면 체크 표시
}
...
{
	// TODO: 여기에 명령 업데이트 UI 처리기 코드를 추가합니다.
	pCmdUI->SetCheck(m_nZoom == 4); // 현재 확대 비율이 4이면 체크 표시
}
