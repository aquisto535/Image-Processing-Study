...
// IppConvert.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CIppConvertApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CIppConvertApp::OnAppAbout)
...
CIppConvertApp::CIppConvertApp() noexcept
{
	...
	SetAppID(_T("IppConvert.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CIppConvertApp 개체입니다.

CIppConvertApp theApp;


// CIppConvertApp 초기화

BOOL CIppConvertApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_IppConvertTYPE,
		RUNTIME_CLASS(CIppConvertDoc),
		RUNTIME_CLASS(CChildFrame), // 사용자 지정 MDI 자식 프레임입니다.
		RUNTIME_CLASS(CIppConvertView));
	if (!pDocTemplate)
		return FALSE;
...
int CIppConvertApp::ExitInstance()
{
...
void CIppConvertApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
